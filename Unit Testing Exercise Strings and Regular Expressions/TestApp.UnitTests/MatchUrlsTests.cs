...
public class MatchUrlsTests
{
    ...
    {
        // Arrange
        string text = "Multiple URLs: https://www.softuni.bg, http://digital.softuni.bg, https://creative.softuni.bg";
        List<string> expected = new() { "https://www.softuni.bg", "http://digital.softuni.bg", "https://creative.softuni.bg" };
